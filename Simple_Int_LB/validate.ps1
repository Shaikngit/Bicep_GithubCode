...
<#
.SYNOPSIS
    Validation script for Simple Internal Load Balancer Bicep template
...
.PARAMETER ResourceGroupName
    Name of the resource group for validation context (default: rg-simple-int-lb-validate)
...
function Test-TemplateValidation {
    ...
    $validateCmd = @(
        ...
        "adminPassword=ValidationPass123!"
...
Write-ColorOutput "✅ Simple Internal Load Balancer Template Validator" "Magenta"
