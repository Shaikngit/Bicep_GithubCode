...
<#
.SYNOPSIS
    Cleanup script for Simple Internal Load Balancer deployment

.DESCRIPTION
    This script removes all resources created by the Simple Internal Load Balancer deployment.
    It provides options for complete cleanup or selective resource removal.

.PARAMETER ResourceGroupName
    Name of the resource group to clean up (default: rg-simple-int-lb)
...
Write-ColorOutput "🧹 Simple Internal Load Balancer Cleanup Script" "Magenta"
