...
<#
.SYNOPSIS
    Validation script for Simple Windows VM Bicep template
...
.PARAMETER ResourceGroupName
    Name of the resource group for validation context (default: rg-simple-windows-vm-validate)
...
Write-ColorOutput "✅ Simple Windows VM Template Validator" "Magenta"
