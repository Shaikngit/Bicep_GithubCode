...
<#
.SYNOPSIS
    Deploys Simple Public Load Balancer Bicep template

.DESCRIPTION
    This script deploys a simple public load balancer with backend VMs and supporting network infrastructure.
    The deployment includes proper validation, error handling, and detailed logging.

.PARAMETER ResourceGroupName
    Name of the resource group to deploy to (default: rg-simple-pub-lb)
...
param(
    ...
    [string]$ResourceGroupName = "rg-simple-pub-lb",
...
function Get-UserConfirmation {
    ...
    Write-ColorOutput "⚠️  Public Load Balancer: ~$20/month" "Yellow"
    Write-ColorOutput "⚠️  Backend VMs (2x B2s): ~$60-80/month" "Yellow"
    Write-ColorOutput "⚠️  Public IP: ~$4/month" "Yellow"
    Write-ColorOutput "⚠️  Total estimated cost: ~$85-105/month" "Yellow"
...
function Start-Deployment {
    $deploymentName = "simple-pub-lb-$(Get-Date -Format 'yyyyMMdd-HHmmss')"
...
Write-ColorOutput "🔥 Simple Public Load Balancer Deployment Script" "Cyan"
...
Write-ColorOutput "" "White"
Write-ColorOutput "🏗️  SIMPLE PUBLIC LOAD BALANCER DEPLOYMENT" "Cyan"
Write-ColorOutput "========================================" "Cyan"
Write-ColorOutput "This script will deploy:" "White"
Write-ColorOutput "• Public Load Balancer (Standard SKU)" "White"
Write-ColorOutput "• Backend Windows VMs" "White"
Write-ColorOutput "• Virtual Network with subnet" "White"
Write-ColorOutput "• Network Security Groups" "White"
Write-ColorOutput "• Public IP address" "White"
Write-ColorOutput "" "White"
