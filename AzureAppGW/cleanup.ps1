...
<#
.SYNOPSIS
    Cleanup script for Azure Application Gateway deployment

.DESCRIPTION
    This script removes all resources created by the Azure Application Gateway deployment.
    It provides options for complete cleanup or selective resource removal.

.PARAMETER ResourceGroupName
    Name of the resource group to clean up (default: rg-azure-appgw)
...
Write-ColorOutput "🧹 Azure Application Gateway Cleanup Script" "Magenta"
