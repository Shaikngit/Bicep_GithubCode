...
<#
.SYNOPSIS
    Validation script for Simple Linux VM Bicep template
...
.PARAMETER ResourceGroupName
    Name of the resource group for validation context (default: rg-simple-linux-vm-validate)
...
param(
    ...
    [Parameter(Mandatory=$false)]
    [string]$ResourceGroupName = "rg-simple-linux-vm-validate",
...
function Test-WhatIfDeployment {
    ...
    $whatifCmd = @(
        ...
        "adminPasswordOrKey=WhatIfPass123!"
        "authenticationType=password"
        "vmSizeOption=Non-Overlake"
    )
...
Write-ColorOutput "✅ Simple Linux VM Template Validator" "Magenta"
