...
<#
.SYNOPSIS
    Cleanup script for Simple Linux VM deployment

.DESCRIPTION
    This script removes all resources created by the Simple Linux VM deployment.
    It provides options for complete cleanup or selective resource removal.

.PARAMETER ResourceGroupName
    Name of the resource group to clean up (default: rg-simple-linux-vm)
...
Write-ColorOutput "🧹 Simple Linux VM Cleanup Script" "Magenta"
